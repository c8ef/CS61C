...
SHORTER_TESTS = 01-simple 02-direction 03-tail 04-food 05-wall 06-small 07-large 08-multisnake 09-everything 10-filled 11-manyclose 12-corner 13-sus 14-orochi 15-hydra
...
run-nonexistent-input-file-test: snake
	@# Test that passing in a nonexistent input filename returns -1
	@$(eval RETURN_CODE = $(shell ./snake -i "tests/22-nonexistent-in.snk" -o "tests/22-nonexistent-out.snk"; echo $$?))
